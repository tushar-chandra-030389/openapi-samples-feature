...
export function subscribeBatch(params, onUpdate, onError) {
...
export function disposeIndividualSubscriptionBatch(accessToken, subscription) {
    getBatchStreamingObj(accessToken).disposeSubscription(subscription);
}
